                            ...
                            <div @class([
                                ...
                                <div class="flex flex-col gap-2 max-w-[95%]  relative">
                                    ...
                                    @if ($attachment)
                                        ...
                                        @endif
                                        {{-- Attachemnt is Application/ or Text/ or Audio/ --}}
                                        @if (str()->startsWith($attachment->mime_type, 'application/') || str()->startsWith($attachment->mime_type, 'text/') || str()->startsWith($attachment->mime_type, 'audio/'))
