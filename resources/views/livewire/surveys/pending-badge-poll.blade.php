    ...
    x-data="{
        ...
        updateDom() {
            ...
            if (!link) {
                ...
                link = items.find(el => el.textContent?.trim() === 'Mis encuestas');
            }
            if (!link) return
            let badge = link.querySelector('.fi-sidebar-item-badge') || link.querySelector('.fi-badge') || link.querySelector('#fp-my-surveys-badge')
