                        ...
                        <div class="swiper-slide">
                            <div class="i hh rm sg vk xm bi qj">
                                ...
                                <div class="tc sf rn tn un zf dp">
                                    <img class="bf" src="{{ asset('/asset/images/portada/testimonial.png') }}" alt="User" />

                                    <div>
                                        <img class="bf" src="{{ asset('/asset/images/portada/icon-quote.svg') }}" alt="Quote" />
                                        ...
                                        <div class="tc yf vf">
                                            ...
                                            <img class="rk" src="{{ asset('/asset/images/portada/brand-light-02.svg') }}" alt="Brand" />
                                        </div>
                                    </div>
                                </div>
                            </div>
