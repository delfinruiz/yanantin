<div>
    <section class="i pg ji gp uq">
        ...
        <img src="{{ asset('/asset/images/portada/shape-08.svg') }}" alt="Shape Bg" class="h q r" />
        <img src="{{ asset('/asset/images/portada/shape-09.svg') }}" alt="Shape" class="of h y z/2" />
        <img src="{{ asset('/asset/images/portada/shape-10.svg') }}" alt="Shape" class="h _ aa" />
        <img src="{{ asset('/asset/images/portada/shape-11.svg') }}" alt="Shape" class="of h m ba" />
            ...
            <div class="wc qf pn xo gg cp">
                ...
                <div class="animate_top rj">
                    <div class="c i pg z-1">
                        <img class="vd" src="{{ asset('/asset/images/portada/team-01.png') }}" alt="Team" />
                ...
                <div class="animate_top rj">
                    <div class="c i pg z-1">
                        <img class="vd" src="{{ asset('/asset/images/portada/team-02.png') }}" alt="Team" />
                ...
                <div class="animate_top rj">
                    <div class="c i pg z-1">
                        <img class="vd" src="{{ asset('/asset/images/portada/team-03.png') }}" alt="Team" />
