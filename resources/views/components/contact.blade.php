<div>
    <section id="support" class="i pg fh rm ji gp uq">
        <!-- Bg Shapes -->
        <img src="{{ asset('/asset/images/portada/shape-06.svg') }}" alt="Shape" class="h aa y" />
        <img src="{{ asset('/asset/images/portada/shape-03.svg') }}" alt="Shape" class="h ca u" />
        <img src="{{ asset('/asset/images/portada/shape-07.svg') }}" alt="Shape" class="h w da ee" />
        ...
        <div class="i va bb ye ki xn wq jb mo">
            <div class="tc uf sn tf rn un zf xl:gap-10">
                <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
                    <!-- Bg Shapes -->
                    <img src="{{ asset('/asset/images/portada/shape-03.svg') }}" alt="Shape" class="h la x wd" />
                    <img src="{{ asset('/asset/images/portada/shape-06.svg') }}" alt="Shape" class="h la ma ne kf" />
