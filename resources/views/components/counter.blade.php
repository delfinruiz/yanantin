<div>
    <section class="i pg qh rm ji hp">
        <img src="{{ asset('/asset/images/portada/shape-11.svg') }}" alt="Shape" class="of h ga ha ke" />
        <img src="{{ asset('/asset/images/portada/shape-07.svg') }}" alt="Shape" class="h ia o ae jf" />
        <img src="{{ asset('/asset/images/portada/shape-14.svg') }}" alt="Shape" class="h ja ka" />
        <img src="{{ asset('/asset/images/portada/shape-15.svg') }}" alt="Shape" class="h q p" />
