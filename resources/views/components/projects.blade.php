            ...
            <div class="projects-wrapper tc -ud-mx-5">
                ...
                <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
                    <div class="c i pg sg z-1">
                        <img src="{{ asset('/asset/images/portada/project-01.png') }}" alt="Project" />
                ...
                <div class="project-item wi fb vd jn/2 to/3 digital">
                    <div class="c i pg sg z-1">
                        <img src="{{ asset('/asset/images/portada/project-02.png') }}" alt="Project" />
                ...
                <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
                    <div class="c i pg sg z-1">
                        <img src="{{ asset('/asset/images/portada/project-04.png') }}" alt="Project" />
                ...
                <div class="project-item wi fb vd vo/3 digital ecommerce">
                    <div class="c i pg sg z-1">
                        <img src="{{ asset('/asset/images/portada/project-03.png') }}" alt="Project" />
