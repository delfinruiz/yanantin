        ...
        <div class="bb ze ki xn yq mb en">
            <div class="wc qf pn xo ng">
                ...
                <div class="animate_top sg oi pi zq ml il am cn _m">
                    <img src="{{ asset('/asset/images/portada/icon-04.svg') }}" alt="Icon" />
                ...
                <!-- Service Item -->
                <div class="animate_top sg oi pi zq ml il am cn _m">
                    <img src="{{ asset('/asset/images/portada/icon-05.svg') }}" alt="Icon" />
                ...
                <!-- Service Item -->
                <div class="animate_top sg oi pi zq ml il am cn _m">
                    <img src="{{ asset('/asset/images/portada/icon-06.svg') }}" alt="Icon" />
                ...
                <!-- Service Item -->
                <div class="animate_top sg oi pi zq ml il am cn _m">
                    <img src="{{ asset('/asset/images/portada/icon-07.svg') }}" alt="Icon" />
