<div>
    <section class="gj do ir hj sp jr i pg">
        ...
        <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
            <img src="{{ asset('/asset/images/portada/shape-01.svg') }}" alt="shape" class="xc 2xl:ud-block h t -ud-left-[10%] ua" />
            <img src="{{ asset('/asset/images/portada/shape-02.svg') }}" alt="shape" class="xc 2xl:ud-block h u p va" />
            <img src="{{ asset('/asset/images/portada/shape-03.svg') }}" alt="shape" class="xc 2xl:ud-block h v w va" />
            <img src="{{ asset('/asset/images/portada/shape-04.svg') }}" alt="shape" class="h q r" />
            <img src="{{ asset('/asset/images/portada/hero.png') }}" alt="Woman" class="h q r ua" />
        </div>
