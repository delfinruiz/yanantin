...
@section('content')
  <main>
        ...
        <div class="wc qf pn xo zf iq">
          ...
          <div class="animate_top sg vk rm xm">
            ...
            <div class="yh">
              <div class="tc uf wf ag jq">
                <div class="tc wf ag">
                  <img src="{{ asset('/asset/images/portada/icon-man.svg') }}" alt="User" />
                  <p>Musharof Chy</p>
                </div>
                <div class="tc wf ag">
                  <img src="{{ asset('/asset/images/portada/icon-calender.svg') }}" alt="Calender" />
                  <p>25 Dec, 2025</p>
                </div>
              </div>
          ...
          <div class="animate_top sg vk rm xm">
            ...
            <div class="yh">
              ...
              <h4 class="ek tj ml il kk wm xl eq lb">
                <span>Tips to quickly improve your coding speed.</span>
              </h4>
            </div>
          </div>
        </div>
    ...
    <section class="i pg gh ji">
      <!-- Bg Shape -->
      <img class="h p q" src="{{ asset('/asset/images/portada/shape-16.svg') }}" alt="Bg Shape" />
