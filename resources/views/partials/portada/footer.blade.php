      ...
      <div class="ji gp">
        <div class="tc uf ap gg fp">
          <div class="animate_top zd/2 to/4">
            <a href="{{ route('home') }}">
              <img src="{{ $logo_light }}" alt="{{ $company_name }}" class="om" style="max-height: 80px; width: auto;" />
              <img src="{{ $logo_dark }}" alt="{{ $company_name }}" class="xc nm" style="max-height: 80px; width: auto;" />
            </a>
