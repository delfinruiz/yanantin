  <header class="g s r vd ya cj" :class="{ 'hh sm _k dj bl ll' : stickyMenu }"
    ...
    <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
      <div class="vd to/4 tc wf yf">
        <a href="{{ route('home') }}">
          <img class="om" src="{{ $logo_light }}" alt="{{ $company_name }}" style="max-height: 80px; width: auto;" />
          <img class="xc nm" src="{{ $logo_dark }}" alt="{{ $company_name }}" style="max-height: 80px; width: auto;" />
        </a>
        ...
        <div class="tc wf ig pb no">
          <div class="pc h io pa ra" :class="navigationOpen ? '!-ud-visible' : 'd'">
            <label class="rc ab i">
              ...
              <!-- Icon Sun -->
              <img class="xc nm" src="{{ asset('/asset/images/portada/icon-moon.svg') }}" alt="Moon" />
            </label>
          </div>
